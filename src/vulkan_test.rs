...
use crate::common::{Result as ElikarResult, SdlError};
use std::ptr::{null_mut, null};
use crate::{Elikar, ElikarStates};
...
fn test() {
    ...
    // read spir-v
    let mut vs_file = File::open("./shaders/vert.spv").unwrap();
    let mut fs_file = File::open("./shaders/frag.spv").unwrap();
